...
const LatestJobCards = ({job}) => {
    ...
    return (
        <div 
            ...
            className='group p-8 rounded-3xl bg-white border border-gray-200 cursor-pointer hover:shadow-2xl hover:shadow-yellow-400/10 hover:scale-105 hover:border-yellow-300 transition-all duration-300 relative overflow-hidden'
        >
            ...
            <div className="relative z-10">
                ...
                <div className="mb-6">
                    <h2 className='font-poppins font-bold text-2xl text-gray-900 mb-3 leading-tight'>
                        {job?.title}
                    </h2>
                ...
                <div className='flex flex-wrap gap-3'>
                    <Badge 
                        className='bg-blue-50 text-blue-700 hover:bg-blue-100 font-inter font-semibold px-3 py-1 rounded-full border border-blue-200' 
                        variant="secondary"
                    >
                        <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <Badge 
                        className='bg-green-50 text-green-700 hover:bg-green-100 font-inter font-semibold px-3 py-1 rounded-full border border-green-200' 
                        variant="secondary"
                    >
                        <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <Badge 
                        className='bg-yellow-50 text-yellow-700 hover:bg-yellow-100 font-inter font-semibold px-3 py-1 rounded-full border border-yellow-200' 
                        variant="secondary"
                    >
                        <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
