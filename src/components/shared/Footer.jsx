...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 border-t border-white/10 py-12">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0 text-center md:text-left">
            <h2 className="text-2xl font-bold font-poppins bg-gradient-to-r from-yellow-400 via-yellow-500 to-amber-500 bg-clip-text text-transparent">
              InveCareer
            </h2>
            <p className="text-sm font-inter text-gray-400 mt-2">
              © 2025 InveCareer. All rights reserved.
            </p>
          ...
          <div className="flex space-x-6">
            <a 
              ...
              className="text-gray-400 hover:text-yellow-400 transition-all duration-300 hover:scale-110 hover:rotate-6 group" 
              aria-label="Facebook"
            >
              <div className="p-2 rounded-full bg-white/5 group-hover:bg-yellow-400/10 transition-all duration-300">
